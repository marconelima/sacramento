...
if(isset($_POST['gravar']) && $_POST['gravar'] == "Gravar"){
	...
	$ano =    	strip_tags(trim($dados[$tabela]['ano']));
...
?>
	...
	<form class="form-horizontal" role="form" name="formNoticia" method="post" enctype="multipart/form-data" action="">
    	...
    	<div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="dados[<?php echo $tabela;?>][ano]" value="<?php echo @$ano; ?>" class="form-control" id="ano" placeholder="Ano">
            </div>
        </div>

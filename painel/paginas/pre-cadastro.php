                    ...
                    <form name="af-form" method="post" action="" class="af-form row" id="af-form">
                        ...
                        if(isset($_POST['enviar']) && $_POST['enviar'] == 'Enviar'){
                            ...
                            if(empty($retorno)){
                                ...
                                $dados2['cliente_pre_cadastro']['endereco'] =  $_POST['endereco']." - ".$_POST['numero'];
    ...
    Recebido em: $date<br>
                        ...
                        <div class="col-sm-12 af-outer af-required ">
                            <div class="form-group af-inner">
                                ...
                                <input type="text" name="cpf" id="cpf" size="30" value="<?php echo @$cep;?>" placeholder="CPF (somente números) *" class="form-control placeholder" />
                        ...
                        <div class="col-sm-12 af-outer ">
                            <div class="form-group af-inner">
                                ...
                                <input type="text" name="phone" id="phone" size="30" value="<?php echo @$phone;?>" placeholder="DDD + Telefone Fixo *" class="form-control placeholder" />
                        ...
                        <div class="col-sm-12 af-outer ">
                            <div class="form-group af-inner">
                                ...
                                <input type="text" name="tel_recado" id="tel_recado" size="30" value="<?php echo @$tel_recado;?>" placeholder="DDD + Telefone de Recado" class="form-control placeholder" />
                         ...
                         <div class="col-sm-12 af-outer af-required ">
                            <div class="form-group af-inner">
                                <span>Email *</span>
                                <input type="email" name="email" id="email" size="30" value="<?php echo @$email;?>" placeholder="Email *" class="form-control placeholder" />
                        ...
                        <div class="col-sm-12 af-outer coluna_campo">
                            <div class="form-group af-inner">
                                <span>DDD + Telefone Fixo *</span>
                                <input type="text" name="ref1_phone" id="ref1_phone" size="30" value="<?php echo @$ref1_phone;?>" placeholder="DDD + Telefone Fixo *" class="form-control placeholder" />
                        ...
                        <div class="col-sm-12 af-outer coluna_campo">
                            <div class="form-group af-inner">
                                <span>DDD + Celular *</span>
                                <input type="text" name="ref1_cel" id="ref1_cel" size="30" value="<?php echo @$ref1_cel;?>" placeholder="DDD + Celular *" class="form-control placeholder" />
                        ...
                        <div class="col-sm-12 af-outer coluna_campo">
                            <div class="form-group af-inner">
                                <span>DDD + Telefone Fixo *</span>
                                <input type="text" name="ref2_phone" id="ref2_phone" size="30" value="<?php echo @$ref2_phone;?>" placeholder="DDD + Telefone Fixo *" class="form-control placeholder" />
                        ...
                        <div class="col-sm-12 af-outer coluna_campo">
                            <div class="form-group af-inner">
                                <span>DDD + Celular *</span>
                                <input type="text" name="ref2_cel" id="ref2_cel" size="30" value="<?php echo @$ref2_cel;?>" placeholder="DDD + Celular *" class="form-control placeholder" />
                        ...
                        <div class="col-sm-12 af-outer coluna_campo">
                            <div class="form-group af-inner">
                                <span>DDD + Telefone Fixo *</span>
                                <input type="text" name="ref3_phone" id="ref3_phone" size="30" value="<?php echo @$ref3_phone;?>" placeholder="DDD + Telefone Fixo *" class="form-control placeholder" />
                        ...
                        <div class="col-sm-12 af-outer coluna_campo">
                            <div class="form-group af-inner">
                                <span>DDD + Celular *</span>
                                <input type="text" name="ref3_cel" id="ref3_cel" size="30" value="<?php echo @$ref3_cel;?>" placeholder="DDD + Celular *" class="form-control placeholder" />

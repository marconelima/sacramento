...
?>
    ...
    <a href="home.php?pagina=depoimentos_liberados&amp;tela=25"><button type="button" class="btn btn-primary btn_direita"><span class="glyphicon glyphicon-plus"></span> Visualizar comentários aprovados</button></a>
    <a href="home.php?pagina=depoimento&amp;tela=25&amp;aprovar_todos=todos"><button type="button" class="btn btn-primary btn_direita"><span class="glyphicon glyphicon-plus"></span> Aprovar todos</button></a>

        <div class="separa"></div>

    <?php
		$sql = "SELECT * FROM tbdepoimento WHERE status = 0 ORDER BY id DESC";
		$resultado = $conecta->selecionar($conecta->conn,$sql);
        ...
        <table class="table table-hover">
          <thead>
            <tr>
              <th width="50%">Depoimento</th>
              <th class="central">Aprovar</th>
              <th class="central">Editar</th>
          ...
          <?php
			...
			?>
          	<tr>
                ...
                <td align="center">
                    <div id="comentario_aprovar"><a href="home.php?pagina=depoimento&amp;aprovar=<?php echo $rs['id']?>&amp;tela=<?php echo $_GET['tela'];?>" ><span class="glyphicon glyphicon-ok"></span></a></div>
                </td>
                <td align="center">
                    <div id="comentario_editar"><a href="home.php?pagina=depoimento&amp;editar=<?php echo $rs['id']?>&amp;tela=<?php echo $_GET['tela'];?>" ><span class="glyphicon glyphicon-pencil"></span></a></div>
                </td>
                <td align="center">
	...
	<?php } else { ?>
			<div style="width:100%; height:auto; float:left; margin:20px 0; font:11px 'Trebuchet MS', Arial, Helvetica, sans-serif; color:#45747B; text-align:center;">Sem depoimentos pendentes</div>
    <?php
		}
	}
	?>

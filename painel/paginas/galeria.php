    ...
    <?php } else {?>
        ...
        <table class="table table-hover">
          <thead>
            <tr>
              ...
              <th class="central">Inserir Fotos</th>
	  ...
	  ?>
		<tr>
          ...
          <td align="center"><a href="home.php?pagina=foto&amp;id=<?php echo $rs['id']; ?>&amp;tela=<?php echo $idtela;?>"><span class="glyphicon glyphicon-picture"></span></a></td>

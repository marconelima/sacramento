...
?>
    ...
    <a href="home.php?pagina=comentarios_liberados&amp;tela=<?php echo $_GET['tela'];?>"><button type="button" class="btn btn-primary btn_direita"><span class="glyphicon glyphicon-plus"></span> Visualizar comentários aprovados</button></a>
    <a href="home.php?pagina=comentario&amp;tela=<?php echo $_GET['tela'];?>&amp;aprovar_todos=todos"><button type="button" class="btn btn-primary btn_direita"><span class="glyphicon glyphicon-plus"></span> Aprovar todos</button></a>
    ...
    <?php
		...
		$sql = "SELECT * FROM tbcomentario WHERE status = 0 AND tabela = '$tab' ORDER BY pai_id ASC, data ASC";
				...
				while($rs = mysqli_fetch_array($resultado)){
					...
					?>
		          	<tr>
		                ...
		                <td align="center">
		                    <div id="comentario_aprovar"><a href="home.php?pagina=comentario&amp;aprovar=<?php echo $rs['id']?>&amp;tela=<?php echo $_GET['tela'];?>" ><span class="glyphicon glyphicon-ok"></span></a></div>
		                </td>
		                <td align="center">
		                    <div id="comentario_editar"><a href="home.php?pagina=comentario&amp;editar=<?php echo $rs['id']?>&amp;tela=<?php echo $_GET['tela'];?>" ><span class="glyphicon glyphicon-pencil"></span></a></div>
		                </td>
		                <td align="center">

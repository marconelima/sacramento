...
if(isset($_POST['gravar']) && $_POST['gravar'] == "Gravar"){
	...
	$profissao =    	strip_tags(trim($dados[$tabela]['profissao']));
...
?>
	...
	<form class="form-horizontal" role="form" name="formNoticia" method="post" enctype="multipart/form-data" action="">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="dados[<?php echo $tabela;?>][profissao]" value="<?php echo @$profissao; ?>" class="form-control" id="profissao" placeholder="Profissão">
            </div>
        </div>
    ...
    <?php } else {?>
	  ...
	  ?>
		<tr>
          ...
          <td align="center"><a href="../index.php" target="_blank"><span class="glyphicon glyphicon-eye-open"></span></a></td>

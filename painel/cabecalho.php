...
<head>
    ...
    <script language="javascript" src="../js/jquery2.min.js"></script>
	...
	<script type="text/javascript">
		...
		tinymce.init({
		   ...
		   external_plugins: { "filemanager" : "https://www.industriasacramento.com.br/js/tinymce/plugins/filemanager/plugin.min.js"}
		});
...
<body class="body_fundo">
	<div class="container">
    	<div class="row cabecalho">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            	<img src="<?php echo $rs_configuracao['logomarca'];?>" class="logo_painel" height="50" />
            </div>

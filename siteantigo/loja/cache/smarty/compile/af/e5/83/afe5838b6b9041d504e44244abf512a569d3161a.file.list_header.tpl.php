<?php /* Smarty version Smarty-3.1.14, created on 2014-12-11 14:28:13
         compiled from "E:\home\industrias118\industriasacramento.com.br\web\loja\admin0976\themes\default\template\controllers\backup\helpers\list\list_header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12585489c61d844288-56176272%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'afe5838b6b9041d504e44244abf512a569d3161a' => 
    array (
      0 => 'E:\\home\\industrias118\\industriasacramento.com.br\\web\\loja\\admin0976\\themes\\default\\template\\controllers\\backup\\helpers\\list\\list_header.tpl',
      1 => 1416572596,
      2 => 'file',
    ),
    'ba5c3fc4808d5ce3715a59bb4366423b9ab135fb' => 
    array (
      0 => 'E:\\home\\industrias118\\industriasacramento.com.br\\web\\loja\\admin0976\\themes\\default\\template\\helpers\\list\\list_header.tpl',
      1 => 1416572579,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12585489c61d844288-56176272',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5489c61f96d927_43880642',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5489c61f96d927_43880642')) {function content_5489c61f96d927_43880642($_smarty_tpl) {?>
...
">
				<i class="icon-download"></i> 
				<?php echo smartyTranslate(array('s'=>'Download the backup file'),$_smarty_tpl);?>
 (<?php echo $_smarty_tpl->tpl_vars['backup_weight']->value;?>
<?php echo smartyTranslate(array('s'=>'MB'),$_smarty_tpl);?>
)
			</a>
		</p>
		<p><?php echo smartyTranslate(array('s'=>'Tip: You can also download this file over to your FTP. Backup files are located in the "admin/backups" directory.'),$_smarty_tpl);?>
</p>
	</div>
	<?php }?>
		...
		<div class="alert alert-warning">
			...
			<ol>
				...
				<li><?php echo smartyTranslate(array('s'=>'You should backup your data on a regular basis (both files and database).'),$_smarty_tpl);?>
</li>
...
" class="form-horizontal clearfix" id="<?php echo $_smarty_tpl->tpl_vars['list_id']->value;?>
">
...
<?php }?>" ></i>
				...
				<?php } ?>
					<a id="desc-<?php echo $_smarty_tpl->tpl_vars['table']->value;?>
-refresh" class="list-toolbar-btn" href="javascript:location.reload();">
...
<?php }?>
	...
	<div class="table-responsive clearfix<?php if (isset($_smarty_tpl->tpl_vars['use_overflow']->value)&&$_smarty_tpl->tpl_vars['use_overflow']->value){?> overflow-y<?php }?>">
		<table <?php if ($_smarty_tpl->tpl_vars['table_id']->value){?> id=<?php echo $_smarty_tpl->tpl_vars['table_id']->value;?>
...
?>
							...
							<?php if ((!isset($_smarty_tpl->tpl_vars['params']->value['orderby'])||$_smarty_tpl->tpl_vars['params']->value['orderby'])&&!$_smarty_tpl->tpl_vars['simple_header']->value&&$_smarty_tpl->tpl_vars['show_filters']->value){?>
								<a <?php if (isset($_smarty_tpl->tpl_vars['order_by']->value)&&($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['order_by']->value)&&($_smarty_tpl->tpl_vars['order_way']->value=='DESC')){?>class="active"<?php }?>  href="<?php echo $_smarty_tpl->tpl_vars['currentIndex']->value;?>
...
<?php }?>">
								...
								<a <?php if (isset($_smarty_tpl->tpl_vars['order_by']->value)&&($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['order_by']->value)&&($_smarty_tpl->tpl_vars['order_way']->value=='ASC')){?>class="active"<?php }?> href="<?php echo $_smarty_tpl->tpl_vars['currentIndex']->value;?>
&amp;<?php echo $_smarty_tpl->tpl_vars['list_id']->value;?>
Orderby=<?php echo urlencode($_smarty_tpl->tpl_vars['key']->value);?>
&amp;<?php echo $_smarty_tpl->tpl_vars['list_id']->value;?>
								...
								<?php }elseif($_smarty_tpl->tpl_vars['params']->value['type']=='date'||$_smarty_tpl->tpl_vars['params']->value['type']=='datetime'){?>
									<div class="date_range row">
										<div class="input-group fixed-width-md row-margin-bottom">
											<input type="text" class="filter datepicker date-input form-control" id="<?php echo $_smarty_tpl->tpl_vars['params']->value['id_date'];?>
...
<?php }?>" placeholder="<?php echo smartyTranslate(array('s'=>'From'),$_smarty_tpl);?>
"/>
...
<?php }?>" placeholder="<?php echo smartyTranslate(array('s'=>'To'),$_smarty_tpl);?>
" />
											<span class="input-group-addon">
												<i class="icon-calendar"></i>
											</span>

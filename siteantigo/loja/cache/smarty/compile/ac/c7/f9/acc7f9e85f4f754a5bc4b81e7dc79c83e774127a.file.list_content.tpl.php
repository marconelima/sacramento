<?php /* Smarty version Smarty-3.1.14, created on 2014-11-25 13:45:00
         compiled from "E:\home\industrias118\industriasacramento.com.br\web\loja\admin0976\themes\default\template\helpers\list\list_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:279765474a3fc7a0775-96368362%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'acc7f9e85f4f754a5bc4b81e7dc79c83e774127a' => 
    array (
      0 => 'E:\\home\\industrias118\\industriasacramento.com.br\\web\\loja\\admin0976\\themes\\default\\template\\helpers\\list\\list_content.tpl',
      1 => 1416572579,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '279765474a3fc7a0775-96368362',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5474a3fdd030c1_60324372',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5474a3fdd030c1_60324372')) {function content_5474a3fdd030c1_60324372($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include 'E:\\home\\industrias118\\industriasacramento.com.br\\web\\loja\\tools\\smarty\\plugins\\modifier.regex_replace.php';
?>
<tbody>
				...
				<?php if (isset($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value])){?>
					...
					<?php }elseif(isset($_smarty_tpl->tpl_vars['params']->value['position'])){?>
						<?php if ($_smarty_tpl->tpl_vars['order_by']->value=='position'&&$_smarty_tpl->tpl_vars['order_way']->value!='DESC'){?>
							<div class="dragGroup">
								<div class="positions">
									<?php echo $_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]['position'];?>
...
<?php }else{ ?>
	<tr>
		<td class="list-empty" colspan="<?php echo count($_smarty_tpl->tpl_vars['fields_display']->value)+2;?>
">

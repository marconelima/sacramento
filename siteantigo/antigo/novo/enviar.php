...
<a href="#" onclick="toggle('apDiv3');"><font size="2" color="#FFFFFF">Meu cadastro </font></a>        </td>
    ...
    <p>&nbsp;</p>
    <h1><strong>Contato</strong><img src="img/listra.png" width="760" height="15" /></h1>
    <p>
...
$hoje = ($hoje_tmp[hours].":".$hoje_tmp[minutes].":".$hoje_tmp[seconds]);
    ...
    $corpo .= "comentario: " . $_POST["comentario"] . "\n";
    
    
    $assunto = "Contato - Denacl-ta";
	...
	$comentario = $_POST["comentario"]; //trata a variável mensagem
	
	global $email; //transforma em variavel global a variável e-mail
	
	$enviou = mail("contato@.com.br", 
		...
		echo "<center><b>$nome</b>, sua mensagem foi enviada com sucesso.<br>Em breve lhe responderemos.</center>";
    ...
    <form id="Contato" name="Contato" method="post" action="enviar.php">
      <table width="550" border="0" cellspacing="0" cellpadding="5">
        ...
        <tr>
          <td>Assunto:</td>
          <td><label>
            <input name="assunto" type="text" id="assunto" size="50" maxlength="100" />
          </label></td>
        </tr>
        <tr>
          <td>Mensagem:</td>
          <td><label>
            <textarea name="comentario" cols="40" rows="5" wrap="virtual" id="comentario"></textarea>
          </label></td>
        </tr>
        <tr>
          <td>&nbsp;</td>

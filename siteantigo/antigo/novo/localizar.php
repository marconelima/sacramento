...
<script type="text/javascript" src="listar/js/prototype.js"></script>
<script type="text/javascript" src="listar/js/scriptaculous.js?load=effects,builder"></script>
<script type="text/javascript" src="listar/js/lightbox.js"></script>
<link rel="stylesheet" href="listar/css/lightbox.css" type="text/css" media="screen" />
...
<a href="#" onclick="toggle('apDiv3');"><font size="2" color="#FFFFFF">Meu cadastro </font></a>        </td>
    ...
    <p><br />
      ...
      <strong>Resultado da busca</strong><img src="img/listra.png" width="760" height="15" /><br />
    </p>
...
error_reporting(0);
	...
	$localizar_prod = $_POST['localizar_prod'];

	
	
	$sql = "select * from produtos where prod_nome like	'%$localizar_prod%'";
	$res = mysql_query ($sql);

  ...
  <div class="header"><a href="#"></a>
    ...
    <table width="100%" height="119" background="img/header.jpg" border="0" cellpadding="1">
      ...
      <tr>
        ...
        <td height="21"><font color="#FFFFFF">_________________</font><a href="index.php" class="classe1">Inicio |</a> <a href="institucional.php" class="classe1">Institucional	 |</a><a href="contato.php" class="classe1"> Contato</a></td>
      </tr>
    </table>
  </div>
  <div class="sidebar1">
...
<div class="content">
    ...
    <table width="910" height="38" border="0" cellpadding="2">
      <tr>
...
<a href="#" onclick="toggle('apDiv3');"><font size="2" color="#FFFFFF">Meu cadastro </font></a>        </td>
    ...
    <div id="banner_flash" >
      <table width="908" height="249" border="0">
    <tr>
      <td width="700"><object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="904" height="252">
        ...
        <!--[if !IE]>-->
        <object type="application/x-shockwave-flash" data="banner.swf" width="904" height="252">
          <!--<![endif]-->
          <param name="quality" value="high" />
          <param name="wmode" value="opaque" />
          <param name="swfversion" value="8.0.35.0" />
    ...
    <table width="729" height="243" background="img/barra_destaques.png" border="0" cellpadding="0">
      <tr>
        <td width="34">&nbsp;</td>
        <td width="161">
...
?><br /></td>
    ...
    <p>&nbsp;</p>
    <table width="850" height="243" background="img/barra_vendidos.png" border="0" cellpadding="0">
      <tr>
...
?>
  ...
  <div class="footer">
    <table width="100%" border="0" cellpadding="0">
      <tr> 
        <td background="img/barra_institucional.jpg"><table width="1095px" height="80px" border="0">
          <tr>
            <td width="207">&nbsp;</td>
            <td width="740">&nbsp;</td>
            <td width="134"><strong>Twitter Sacramento</strong></td>
          </tr>
          <tr>
            <td>&nbsp;</td>

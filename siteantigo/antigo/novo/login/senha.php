  ...
  <div class="header"><a href="#"></a>
    ...
    <table width="100%" height="119" background="../img/header.jpg" border="0" cellpadding="1">
      ...
      <tr>
        ...
        <td height="21"><font color="#FFFFFF">_________________</font><a href="../index.php" class="classe1">Inicio |</a> <a href="../index.php" class="classe1">Institucional	 |</a><a href="../index.php" class="classe1"> Contato</a></td>
      </tr>
    </table>
  </div>
  <div class="sidebar1">
...
<a href="#" onclick="toggle('apDiv3');"><font size="2" color="#FFFFFF">Meu cadastro </font></a>        </td>
    ...
    <p>&nbsp;</p>
    <p><strong>Esqueceu sua senha?</strong><img src="../img/listra.png" width="875" height="15" />
    <center>
...
<p><a href="juridica.php"><strong></strong></a></p>

<p>Informe seu usuário no campo abaixo<br />
  <br />
  <br />
  <br />
<form name="cadastro_form" action="solicitar_senha.php" onSubmit="return validar_campos()" method="post" >
              
  <table width="188" border="0">
            <tr>
              <td width="151">Login*</td>
              
              <td width="121"><input name="usu_login" type="text" size="15" maxlength="50" onSubmit="return validar_campos()" /><input type="submit" value="Enviar"/></td>
              </tr>          
          </table>

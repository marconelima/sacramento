  ...
  <div class="header"><a href="#"></a>
    ...
    <table width="100%" height="119" background="img/header.jpg" border="0" cellpadding="1">
      ...
      <tr>
        ...
        <td height="21"><a href="index.php" class="classe1"><font color="FBF8F3">____________</font>Inicio |</a> <a href="index.php" class="classe1">Institucional	 |</a><a href="index.php" class="classe1"> Contato</a></td>
      </tr>
    </table>
  </div>
  <div class="sidebar1">
...
<a href="#" onclick="toggle('apDiv3');"><font size="2" color="#FFFFFF">Meu cadastro </font></a>        </td>
    ...
    <p>&nbsp;</p>
    <p><strong>Cadastro de novo usuário - Pessoa Jurídica</strong> <br />
      <img src="img/listra.png" width="760" height="15" /><br />
      <br />
<p>
...
<form name="cadastro_form" action="incluir.php" onSubmit="return validar_campos()" method="post" >
          ...
          <table width="525" border="0">
            <tr>
              ...
              <td width="119"><input name="usu_login" type="text" size="18" maxlength="50" onSubmit="return validar_campos()" /></td>
              <td width="125">Senha*</td>
              <td width="123"><input name="usu_senha" type="password" size="18" maxlength="50"  /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              ...
              <td><input name="usu_senha2" type="password" size="18" maxlength="50"  /></td>
            </tr>
            <tr>
              <td>Empresa*</td>
              <td><input name="usu_nome" type="text" size="18" maxlength="100"  /></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>CNPJ*</td>
              <td><input name="usu_cpf_cnpj" type="text" size="18" onkeypress="mascara(this,cnpj)" maxlength="18"  /></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>Razão Social*</td>
              <td><input name="usu_razaosocial" type="text" size="18" maxlength="50"  /></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Endereço*</td>
              <td><input name="usu_end_add" type="text" size="18" maxlength="50"  /></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>Cidade*</td>
              <td><input name="usu_end_cidade" type="text" size="18" maxlength="50"  /></td>
              <td>Estado*</td>
              <td><input name="usu_end_estado" type="text" size="18" maxlength="50"  /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td>Telefone Fixo*</td>
              <td><input name="usu_tel1" type="text" size="18" onkeypress="mascara(this,telefone)" maxlength="14"  /></td>
              <td>Telefone Móvel*</td>
              <td><input name="usu_tel2" type="text" size="18" onkeypress="mascara(this,telefone)" maxlength="14"  /></td>
            </tr>
            <tr>
              <td>E-mail*</td>
              <td><input name="usu_email" type="text" size="18" maxlength="50"  /></td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            <tr>
    ...
    <td width="74%" align="center" valign="top" background="img/fnd_bg.png" bgcolor="#FFFFFF"><p>&nbsp;</p>
          <p><font size="1"><strong>*Preenchimento obrigatório.</strong></font></p></td>

...
<a href="../index.php" onclick="toggle('apDiv3');"><font size="2" color="#FFFFFF">Meu cadastro </font></a>        </td>
    ...
    <p>&nbsp;</p>
    <p><strong>Utilidades Domésticas - Banho</strong>
...
$sql = "select * from produtos where prod_tipo = 'Banho'";
$res = mysql_query ($sql);
$linhas = mysql_num_rows ($res);

		

echo "<br><div align=center><center><table border=0 cellpadding=10 cellspacing=0 style='border-collapse: collapse' bordercolor=#F0F0F0 width=860 id=AutoNumber1>";
...
$sql_tmp = "select * from fabricantes where fabri_nome = '$fabri'";
$res_tmp = mysql_query ($sql_tmp);
$linhas_tmp = mysql_num_rows ($res_tmp);

$fabricante = mysql_result($linhas_tmp,"fabri_nome");

  ...
  <div class="header"><a href="#"></a>
    ...
    <table width="100%" height="119" background="../img/header.jpg" border="0" cellpadding="1">
      ...
      <tr>
        ...
        <td height="21"><font color="FBF8F3">____________</font><a href="../index.php" class="classe1">Inicio |</a> <a href="../index.php" class="classe1">Institucional	 |</a><a href="../index.php" class="classe1"> Contato</a></td>
      </tr>
    </table>
  </div>
  <div class="sidebar1">
...
<ul id="nav">
  ...
  <li><a href="diversossac.php">Diversos</a>
   </ul>
  </li>
</ul>
...
<a href="../index.php" onclick="toggle('apDiv3');"><font size="2" color="#FFFFFF">Meu cadastro </font></a>        </td>
    ...
    <p>&nbsp;</p>
    <p><strong>Utilidades Domésticas - Limpeza</strong>
...
$sql = "select * from produtos where prod_tipo = 'Limpeza'";
$res = mysql_query ($sql);
...
echo "<br><div align=center><center><table border=0 cellpadding=10 cellspacing=0 style='border-collapse: collapse' bordercolor=#F0F0F0 width=778 id=AutoNumber1>";

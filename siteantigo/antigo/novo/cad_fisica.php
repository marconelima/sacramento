...
<a href="#" onclick="toggle('apDiv3');"><font size="2" color="#FFFFFF">Meu cadastro </font></a>        </td>
    ...
    <p>&nbsp;</p>
    <p><strong>Cadastro de novo usuário - Pessoa Física</strong> <img src="img/listra.png" width="760" height="15" /><br />
...
<center>
          ...
          <form name="cadastro_form"
          
          action="incluir.php" onSubmit="return validar_campos()" method="post" >

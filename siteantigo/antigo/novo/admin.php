...
<div class="container">
  ...
  <div class="content"><br />
    ...
    <h1><table width="950px" height="400" border="0" background="img/bg.JPG">
    ...
    <tr>
       ...
       <div id="login">
       	<img src="img/aesso.png"
    
	
      

       	  <p>Usuário: <input name="senha" type="text" size="15" maxlength="50" /></p>
       	  <p>Senha:<font color="#F7F5F0">_ </font><input name="senha" type="password" size="15" maxlength="50" /></p>
		  <p><font color="#F7F5F0">__.__________</font>	<input type="submit" value="Entrar" /></p>

    ...
    <h1><table width="100%" height="262" border="0" id="tabela1">
      <tr>
        <td width="74%" align="center" valign="middle" background="img/bg.jpg" bgcolor="#FFFFFF"><p><center>Consulta de Clientes Cadastrados<br />
          <font size="1">Pessoa Física</font>
        </p>
          <p>&nbsp;</p>
<p></p>
          <p></p>
          <p><br /><br /></p>
            <table width="500" border="0">
              <tr>
                ...
                <form name="FILTRO" action="filtro_cliente_fisica_nome.php" method="post" >
           <p>Buscar por Nome:    </p>
           <p>
                ...
                <form name="FILTRO" action="filtro_cliente_fisica_cpf.php" method="post" >
           <p>Burcar por CPF:    </p>
           <p>
                    <input name="cliente_cpf" type="text" size="13" onkeypress="mascara(this,cpf)" maxlength="14"/>
                    <input type="submit" value="Buscar"/>
          </p>
</form>
...
<form name="FILTRO" action="filtro_cliente_fisica_todos.php" method="post" >
            <p>Listar todos   </p>
            <p>
              <input type="submit" value="Buscar"/>
           </p>

...
<div class="container">
  ...
  <div class="content">
    <h1><table width="100%" height="262" border="0" id="tabela1">
      <tr>
        <td width="74%" align="center" valign="middle" background="img/bg.jpg" bgcolor="#FFFFFF"><p>Alterar produtos mais vendidos</p>
          <p>&nbsp;</p>
          <p><center>Selecione o destaque a ser editado.</p>
          <p><center><font size="0">(Posicionamento em relação a Index do website.)</font></p>
          <p></p>
          <p></p>
            <p><center>
              <a href="alterar_prod_mais_vendido_1.php"><img src="img/vend_1.png" width="557" height="159" /></a><br />
              <br />
              <a href="alterar_prod_mais_vendido_2.php"><img src="img/vend_2.png" width="557" height="159" /></a><br />
              <br />
              <a href="alterar_prod_mais_vendido_3.php"><img src="img/vend_3.png" width="557" height="159" /></a><br /><br />
              <br /><br />
            </p><br />

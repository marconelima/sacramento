...
<div class="container">
  ...
  <div class="content">
    <h1><table width="100%" height="262" border="0" id="tabela1">
      <tr>
        <td width="74%" align="center" valign="middle" background="img/bg.jpg" bgcolor="#FFFFFF"><p><center>Produtos Cadastrados<br />
        </p>
          <p>&nbsp;</p>
<p></p>
          <p></p>
...
<form name="FILTRO" action="filtro_prod_tipo.php" method="post" >
            <p>Buscar por Tipo:              </p>
            <p>
...
<form name="FILTRO" action="filtro_prod_nome.php" method="post" >
           <p>Burcar por Nome:    </p>
           <p>
                    <input name="prod_nome" type="text" size="13" />
                    <input type="submit" value="Buscar"/>
          </p>
</form>
                ...
                <td>
                  ...
                  <form name="FILTRO" action="filtro_prod_cod.php" method="post" >
            <p>Buscar por Código:    </p>
            <p>
                    <input name="prod_cod" type="text"  size="13" />
                    <input type="submit" value="Buscar"/>
           </p>
</form>              
                
                </td>
                <td><form action="filtro_prod_fabri.php" method="post" name="FILTRO" id="FILTRO2" >
                  <p>Buscar por Fabricante: </p>
                  <p>
...
?>
                ...
                <td><form action="filtro_prod_todos.php" method="post" name="FILTRO" id="FILTRO" >
                  <p>Listar todos: </p>
                  <p><br />
                    <input type="submit" value="Buscar"/>
                    </p>

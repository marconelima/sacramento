  ...
  <table width="980" border="0">
    <tr >
      <td width="507" >
        ...
        <p>        
        <p><center>
          <p><center>Favor selecionar o Fabricante que deseja banir a <br />
            exibição de seus produtos no sistema Sacramento.</p>
</center>
          <br />
          <br />
          <br />
...
?>
  ...
  <br />
  <br />
      <font size="1">*Os produtos do Fabricante não aparecerão mais na listagem de produtos atuais.<br />
      *E</font><font size="1">ste processo é reversível, os produtos do mesmo continuarão em nossa base de dados.<br />
      *Para reverter, basta acrescentar o Fabricante novamente a listagem de fabricantes válidos.</font></p></td>
      <td width="463" ><p><center>Listagem de Fabricantes Banidos</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>

...
<div class="container">
  ...
  <div class="content">
    <h1>
    <a href="admin.php">Voltar</a></p>
    <p>Cadastro de Produtos</p>
    <p><br />
      <br />
    <form name="cadastro_form" action="<?php echo $_SERVER['PHP_SELF'] ?>" onSubmit="return validar_campos()" method="post" enctype="multipart/form-data" >
              ...
              <table width="571" border="0">
                ...
                <tr>
                  ...
                  <td width="272"><input name="fabri_nome" type="text" size="19" maxlength="50"  /></td>
                  <td width="151">&nbsp;</td>
                </tr>
    ...
    <hr />
    <p><center><font size="2"><strong>Fabricantes Cadastrados</p></strong></font>
    <p>&nbsp;</p>
    <p>
    
<center><select name="prod_fabri">
...
?>
    ...
    <br /><br />
    <font size="1">*Para que a listagem de fabricantes cadastrados se atualize, favor atualizar a página.
    </p>
    </font>
    <h1><br /><br /><hr /></h1>

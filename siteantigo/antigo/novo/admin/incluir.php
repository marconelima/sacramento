...
if ($prod_nome == ""){
	echo "Nome do produto - Preenchimento obrigatório.";
}
	elseif ($prod_cod == ""){
		...
		elseif ($prod_tipo == ""){
		 echo "Tipo do produto - Preenchimento obrigatório.";
						...
						elseif ($prod_embalagem == ""){
							...
							elseif ($prod_ean == ""){
								echo "EAN do produto - Preenchimento obrigatório.";
										...
										$inserir = mysql_query("INSERT INTO produtos(prod_nome,prod_cod,prod_tipo,prod_desc,prod_dimen,prod_embalagem,prod_ean) values('$prod_nome','$prod_cod','$prod_tipo','$prod_desc','$prod_dimen','$prod_embalagem','$prod_ean')") or die(mysql_error()); 
        	...
        	$caminho_imagem = "C:/wamp/www/sacramento/img_prod/" . $nome_imagem;
 
			// Faz o upload da imagem para seu respectivo caminho
			move_uploaded_file($prod_foto["tmp_name"], $caminho_imagem);

			// Insere os dados no banco
			$sql = mysql_query("INSERT INTO produtos(prod_foto) VALUES('$nome_imagem')");

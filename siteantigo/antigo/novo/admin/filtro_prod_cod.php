...
$res = mysql_query("select * from produtos where prod_cod = '$prod_cod'");



echo "Código do produto: "; echo $prod_cod;
echo "<br /><br /><br /><center><table border=1><tr><td>Nome</td><td>Tipo</td><td>Fabricante</td><td>Especificação</td><td>Dimensão</td><td>Embalagem</td><td>EAN</td><td>Foto</td></tr>";

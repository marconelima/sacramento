  ...
  <table width="980" border="0">
    <tr >
      <td width="581" >
        ...
        <p><br />
          <center>Favor selecionar o Fabricante que deseja banir a <br />
exibição de seus produtos no sistema Sacramento.
        <p><br /><br />
<br />

        <p>        
        <form action="banir_fabricante_banir.php" method="post">

<select name="prod_fabri">
...
?>
    ...
    <br /><br /><br /><br />
    <input type="submit" value="Banir Fabricante"/>
        ...
        <p>
        <blockquote>
          <p><font size="1">*Os produtos do Fabricante não aparecerão mais na listagem de produtos atuais.<br />
      *E</font><font size="1">ste processo é reversível, os produtos do mesmo continuarão em nossa base de dados.<br />
      *Para reverter, basta acrescentar o Fabricante novamente a listagem de fabricantes válidos.</font></p>
        </blockquote>
      <p>&nbsp;</p></td>
      <td width="389" ><p>
        <?php
	...
	$fabri_nome = $_POST['prod_fabri_tmp'];
	
	$inserir = mysql_query("INSERT INTO fabricantes(fabri_nome) values('$fabri_nome')")or die(mysql_error()); 
	$delete = mysql_query("DELETE FROM fabricantes_tmp where fabri_nome = '$fabri_nome'") or die(mysql_error()); 
	

	
	echo "<center>";
	echo "<strong>Fabricante LIBERADO com sucesso!<br />";
...
<p>&nbsp;</p>
<p><center><strong><a href="banir_fabricante.php">Liberar outros</a></strong></p>

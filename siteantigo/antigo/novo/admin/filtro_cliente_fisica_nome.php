...
$res = mysql_query("select * from usuarios where usu_nome like '%$cliente_nome%'");



echo "Nome do cliente: "; echo $cliente_nome;
...
<td>" . $escrever['usu_nome'] . "</td>
<td>" . $escrever['usu_cpf_cnpj'] . "</td>
<td>" . $escrever['usu_nasc'] . "</td>
<td>" . $escrever['usu_end_estado'] . "</td>
<td>" . $escrever['usu_end_cidade'] . "</td>
<td>" . $escrever['usu_end_adicionais'] . "</td>
<td>" . $escrever['usu_tel1'] . "</td>
<td>" . $escrever['usu_tel2'] . "</td>
<td>" . $escrever['usu_email'] . "</td>

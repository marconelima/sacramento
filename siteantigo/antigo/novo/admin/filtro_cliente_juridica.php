...
<div class="container">
  ...
  <div class="content">
    <h1><table width="100%" height="262" border="0" id="tabela1">
      <tr>
        <td width="74%" align="center" valign="middle" background="img/bg.jpg" bgcolor="#FFFFFF"><p><center>Consulta de Clientes Cadastrados<br />
          <font size="1">Pessoa Jurídica</font>
        </p>
          <p>&nbsp;</p>
<p></p>
          <p></p>
          <p><br /><br /></p>
            <table width="500" border="0">
              <tr>
                ...
                <form name="FILTRO" action="filtro_cliente_juridica_nome.php" method="post" >
           <p>Burcar por Empresa:</p>
           <p>
                    <input name="cliente_nome" type="text" size="13" />
                ...
                <form name="FILTRO" action="filtro_cliente_juridica_cnpj.php" method="post" >
           <p>Burcar por CNPJ:    </p>
           <p>
                    <input name="cliente_cnpj" type="text" size="18" onkeypress="mascara(this,cnpj)" maxlength="18" />
                    <input type="submit" value="Buscar"/>
          </p>
</form>
...
<form name="FILTRO" action="filtro_cliente_juridica_todos.php" method="post" >
            <p>Listar todos</p>
            <p>
              <input type="submit" value="Buscar"/>
           </p>

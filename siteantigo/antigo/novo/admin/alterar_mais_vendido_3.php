...
<div class="container">
  ...
  <div class="content">
    <h1><table width="100%" height="262" border="0" id="tabela1">
      <tr>
        <td width="74%" align="center" valign="middle" background="img/bg.jpg" bgcolor="#FFFFFF"><p>Alterando produto em destaque </p>
          <p><a href="alterar_prod_mais_vendido.php">Voltar</a></p>
          <p><center><img src="img/dest_03.png" width="398" height="123" /></p>
          <p>&nbsp;</p>
          <p>
...
$caminho_imagem = "../img_vend/" . $nome_imagem;
// Faz o upload da imagem para seu respectivo caminho
move_uploaded_file($foto["tmp_name"], $caminho_imagem);
					
					

$sql = "UPDATE vendido_3 SET 
...
echo "Destaque alterado com sucesso!";

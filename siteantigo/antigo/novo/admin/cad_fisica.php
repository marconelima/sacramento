    ...
    <h1><br />
      ...
      <tr>
        ...
        <td width="74%" align="center" valign="top" background="img/fnd_bg.png" bgcolor="#FFFFFF"><p>&nbsp;</p>
          <p>Cadastro de novo usuário - Pessoa Física</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          ...
          <table width="500" border="0">
            <tr>
              <td width="147">Login*</td>
              
              <td width="118"><input name="usu_login" type="text" size="15" maxlength="50" onSubmit="return validar_campos()" /></td>
              <td width="122">Senha*</td>
              <td width="95"><input name="usu_senha" type="password" size="15" maxlength="50"  /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
          ...
          <p><em><font size="0">*Preenchimento obrigatório.</em></p>
          <p>&nbsp;</p>
          <p>&nbsp;</p></td>

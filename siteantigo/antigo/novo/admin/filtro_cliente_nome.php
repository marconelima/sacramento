...
<div class="container">
  ...
  <div class="content">
    <h1><table width="100%" height="262" border="0" id="tabela1">
      <tr>
        <td width="74%" align="center" valign="middle" background="img/bg.jpg" bgcolor="#FFFFFF"><p>
          <?php
...
$res = mysql_query("select * from produtos where prod_tipo = 'Cozinha'");

echo "Tipo do produto: Cozinha";
echo "<br /><br /><br /><center><table border=1><tr><td>Código</td><td>Nome</td><td>Especificação</td><td>Dimensão</td><td>Embalagem</td><td>EAN</td><td>Foto</td></tr>";
...
<td>" . $escrever['prod_cod'] . "</td>
<td>" . $escrever['prod_nome'] . "</td>
<td>" . $escrever['prod_desc'] . "</td>
<td>" . $escrever['prod_dimen'] . "</td>
<td>" . $escrever['prod_embalagem'] . "</td>
<td>" . $escrever['prod_ean'] . "</td>
<td>" . $escrever['prod_foto'] . "</td>
...
$res = mysql_query("select * from produtos where prod_tipo = 'Organizacao'");

echo "Tipo do produto: Organização";
echo "<br /><br /><br /><center><table border=1><tr><td>Nome</td><td>Código</td><td>Descrição</td><td>Dimensão</td><td>Embalagem</td><td>EAN</td><td>Foto</td></tr>";
...
$res = mysql_query("select * from produtos where prod_tipo = 'Mesa'");

echo "Tipo do produto: Mesa";
echo "<br /><br /><br /><center><table border=1><tr><td>Nome</td><td>Código</td><td>Descrição</td><td>Dimensão</td><td>Embalagem</td><td>EAN</td><td>Foto</td></tr>";
...
$res = mysql_query("select * from produtos where prod_tipo = 'Banho'");

echo "Tipo do produto: Banho";
echo "<br /><br /><br /><center><table border=1><tr><td>Nome</td><td>Código</td><td>Descrição</td><td>Dimensão</td><td>Embalagem</td><td>EAN</td><td>Foto</td></tr>";
...
$res = mysql_query("select * from produtos where prod_tipo = 'Limpeza'");

echo "Tipo do produto: Limpeza";
echo "<br /><br /><br /><center><table border=1><tr><td>Nome</td><td>Código</td><td>Descrição</td><td>Dimensão</td><td>Embalagem</td><td>EAN</td><td>Foto</td></tr>";
...
$res = mysql_query("select * from produtos where prod_tipo = 'Infantil'");

echo "Tipo do produto: Infantil";
echo "<br /><br /><br /><center><table border=1><tr><td>Nome</td><td>Código</td><td>Descrição</td><td>Dimensão</td><td>Embalagem</td><td>EAN</td><td>Foto</td></tr>";
...
$res = mysql_query("select * from produtos where prod_tipo = 'Construcao'");

echo "Tipo do produto: Construção";
echo "<br /><br /><br /><center><table border=1><tr><td>Nome</td><td>Código</td><td>Descrição</td><td>Dimensão</td><td>Embalagem</td><td>EAN</td><td>Foto</td></tr>";
...
$res = mysql_query("select * from produtos where prod_tipo = 'Diversos'");

echo "Tipo do produto: Diversos";
echo "<br /><br /><br /><center><table border=1><tr><td>Nome</td><td>Código</td><td>Descrição</td><td>Dimensão</td><td>Embalagem</td><td>EAN</td><td>Foto</td></tr>";

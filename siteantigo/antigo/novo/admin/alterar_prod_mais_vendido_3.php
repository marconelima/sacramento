...
<div class="container">
  ...
  <div class="content">
    <h1>Alterando produto mais vendido</h1>
    <p>&nbsp;</p>
    <p><center><img src="img/vend_3.png" width="557" height="159" /></p>
    <p>&nbsp;</p>
    <p><hr>
    </p>
    <p>Selecione o Fabricante
</p>
    <p>
    
    <center><br />
    
    <form action="alterar_prod_mais_vendido_3_prod.php" method="post">
...
<br /><br /><br /><br /><input type="submit" value="Carregar Produtos"/>

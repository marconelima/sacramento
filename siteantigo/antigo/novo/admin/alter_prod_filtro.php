...
<div class="container">
  ...
  <div class="content">
    <h1><table width="100%" height="262" border="0" id="tabela1">
      <tr>
        <td width="74%" align="center" valign="middle" background="img/bg.jpg" bgcolor="#FFFFFF"><p>Todos Produtos Cadastrados</p>
          <p>
          <br />

          <form name="FILTRO" action="alter_prod_filtro_cod.php" method="post" >
            <p><font size="1">Buscar por Código:</font>    
...
echo "Listagem de todos Produtos";
echo "<br /><br /><br /><center><table border=1><tr>

    ...
    <h1><table width="100%" height="262" border="0" id="tabela1">
      <tr>
        <td width="74%" align="center" valign="middle" background="img/bg.jpg" bgcolor="#FFFFFF"><p><center>Consulta de Clientes Cadastrados<br />
          <font size="1">Favor selecionar a classe:</font>
          <br />
          </p>
<p>&nbsp;</p>
<p></p>
          ...
          <p><br /><br /></p>
            <table width="500" border="0">
              <tr>
                <td><a href="filtro_cliente_fisica.php">Pessoa Física</a></td>
                <td><a href="filtro_cliente_todos.php">Listar Todos</a></td>
                <td><a href="filtro_cliente_juridica.php">Pessoa Jurídica</a></td>
              </tr>
            </table>
            <p>

...
$res = mysql_query("select * from produtos where prod_nome like '%$prod_nome%'");


echo "Nome do produto: "; echo $prod_nome;
echo "<br /><br /><br /><center><table border=1><tr><td>Código</td><td>Nome</td><td>Tipo</td><td>Fabricante</td><td>Especificação</td><td>Dimensão</td><td>Embalagem</td><td>EAN</td><td>Foto</td></tr>";

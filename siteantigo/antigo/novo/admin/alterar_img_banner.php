    ...
    <h1><table width="100%" height="262" border="0" id="tabela1">
      <tr>
        <td width="74%" align="center" valign="middle" background="img/bg.jpg" bgcolor="#FFFFFF"><p>&nbsp;</p>
          <p>Imagens do banner principal </p>
          <p><br /><center><font color="#0066CC">*Resolução da imagem para exibição 908 x 250 px.</font></p>
          <p></p>
...
?>
            ...
            <p><br /><center><a href="JavaScript:location.reload(true);">Atualizar Lista </a> <br /><hr><br />
              <br />
  ...
  <form method="post" action="envia_imagem.php" enctype="multipart/form-data">
      <table width="533" border="0" >
          <tr>
              <td width="186">Acrescentar imagem<br /></td>
              <td width="244"><input type="file" name="arquivo" size="20"/><br /></td>
              <td width="89"><input type="submit" value="Enviar"/></td>
          </tr>
      </table>
  </form>           
	    ...
	    <p><font size="1"><center></center></font><br /></p>
	    <p>

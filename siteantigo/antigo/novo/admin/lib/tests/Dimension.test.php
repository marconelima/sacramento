<?php
  ...
  **/
	...
	class DimensionTest extends UnitTestCase
	{
		...
		function testCenterRelative()
		{
			$this->assertTrue(wiDimension::isCenterRelative('c+10'));
			$this->assertTrue(wiDimension::isCenterRelative('c+10%'));
			$this->assertTrue(wiDimension::isCenterRelative('c + 10'));
			$this->assertTrue(wiDimension::isCenterRelative('c -   10%'));
		}
		...
		function testFix()
		{
			...
			$this->assertIdentical(130, wiDimension::fix(300, 'c-20'));
			
			$this->assertIdentical(-130, wiDimension::fix(200, -130));
			$this->assertIdentical(-40, wiDimension::fix(200, '-20%'));
			$this->assertIdentical(-1, wiDimension::fix(20, '-5%'));
		}
	}
?>
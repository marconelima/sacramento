<?php
  ...
  **/
	...
	include(WI_LIB_PATH . 'mappers/ImageFileMapper_GIF.class.php');
	
	class GIFMapperTest extends UnitTestCase
	{
		protected $mapper;
		
		function setup()
		{
			$this->mapper = wiFileMapperFactory::selectMapper(null, 'gif');
		}

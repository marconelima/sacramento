<?php
  ...
  **/
	...
	class TestableImage extends wiTrueColorImage
	{
		function __destruct()
		{
	...
	class ImageTest extends ImageTester
	{
		...
		{
			Mock::generatePartial('wiTrueColorImage', 'MockImage', array('destroy'));
		...
		function testSaveOverrideFormat()
		{
			...
			{
				$this->fail("Should load image, even though the filename specifies invalid format");
			}

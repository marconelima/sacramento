<?php
  ...
  **/
	...
	class GetMaskTest extends ImageTester
	{
		function testGetMaskTransparentGif()
		{
			...
			$mask = $img->getMask();
			$this->assertTrue($mask instanceof wiTrueColorImage);
			
			$this->assertFalse($mask->isTransparent());
			$this->assertEqual(100, $mask->getWidth());
			$this->assertEqual(100, $mask->getHeight());

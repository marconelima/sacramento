<?php
  ...
  **/
	...
	class GetChannelsTest extends ImageTester
	{
		function testCopyChannel8bit()
		{
			...
			$this->assertTrue($copy instanceof wiPaletteImage);
			...
			$this->assertEqual($copy->getTransparentColor(), $copy->getColorAt(50, 50));
		...
		{
			$img = wiImage::load(IMG_PATH . '100x100-rgbyg.png');

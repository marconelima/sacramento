...
<a href="#" onclick="toggle('apDiv3');"><font size="2" color="#FFFFFF">Meu cadastro </font></a>        </td>
    ...
    <p><br />
    <strong>Parceiros</strong><img src="img/listra.png" width="760" height="15" /><br /><br /><br /><br /><br /><br />
    </p>
    <table width="612" height="290" border="0">
      <tr>
        <td><img src="img/aramig.jpg" width="200" height="51" /></td>
        <td><img src="img/plasmont.jpg" width="224" height="97" /></td>
      </tr>
      <tr>
        <td height="162"><img src="img/rischioto.jpg" width="225" height="64" /></td>
        <td><img src="img/nitron .jpg" width="183" height="88" /></td>
      </tr>
    </table>
<p>&nbsp;</p>
    <p>&nbsp;</p>

  ...
  <div class="header"><a href="#"></a>
    ...
    <table width="100%" height="119" background="img/header.jpg" border="0" cellpadding="1">
      ...
      <tr>
        ...
        <td width="32%" height="21"><a href="index.php" class="classe1"> <font color="FBF8F3">____________</font>Inicio |</a> <a href="institucional.php" class="classe1">Institucional	 |</a><a href="contato.php" class="classe1"> Contato</a></td>
      </tr>
    </table>
  </div>
  <div class="sidebar1">
...
<div class="content">
    ...
    <div id="apDiv3" style="display:none">
		...
		<label>Usuário</label>
		<br />
		<input name="usu_login" type="text" size="15" maxlength="50"  />
		<label><br />
	
				Senha<br />
		</label>
		<input name="usu_senha" type="password" size="15" maxlength="50" />
	
	    <br /><br />
			
            
		<input type="submit" value="Entrar" /></label>
		...
		<font size="-3"><a href="login/senha.php">Esqueceu a senha?</a></font>
    ...
    <table width="799" height="38" border="0" cellpadding="2">
     ...
     <form name="localizar_prod" action="localizar.php" method="post">
      	    ...
      	    <input name="localizar_prod" type="text" id="redondo" value="" size="30" /> 
...
<a href="#" onclick="toggle('apDiv3');"	 ><font size="2" color="#FFFFFF">Meu cadastro </font></a>        </td>
    ...
    <div id="banner_flash" >
      <table width="799" height="249" border="0">
    <tr>
      <td width="700"><object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="794" height="249">
        ...
        <!--[if !IE]>-->
        <object type="application/x-shockwave-flash" data="banner.swf" width="794" height="249">
          <!--<![endif]-->
          <param name="quality" value="high" />
          <param name="wmode" value="opaque" />
          <param name="swfversion" value="8.0.35.0" />
    ...
    <table width="729" height="243" background="img/barra_destaques.png" background-repeat: "no-repeat" border="0" cellpadding="0">
      <tr>
        <td height="29">&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
...
echo "<br /><font size='1'> $nome </font>";

echo "<br /><br />"; 

echo "<img src='img_prod/" . $descricao . "' id='reduzida' ><br />";

echo "<font size='1'> $foto </font>";
...
?><br /></td>
    ...
    <p>&nbsp;</p>
    <table width="799" height="243" background="img/barra_vendidos.png" border="0" cellpadding="0">
      <tr>
        <td align="center" valign="bottom"><table width="730" height="206" border="0" align="center" cellpadding="2">
          <tr>
            <td width="174">
...
?>
  ...
  <div class="footer">
    <table width="100%" height="119" border="0">
      ...
      <tr>
        <td>&nbsp;</td>
        <td><div align="center" class="style1">© Sacramento Industria e Comércio Ltda - ME<br />
          Rua General   Clark, 1030
          <!-- end #footer -->
          - Novo Progresso | Contagem | MG - <span class="style3">(31)   3354.8250</span></div></td>
        <td align="left"><div align="left">
            <table width="100%" border="0">
              <tr>
                ...
                <td width="4%">&nbsp;</td>
                <td width="74%"><div align="center" class="style4">Twitter Sacramento</div></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><div align="center" class="style2">Venha nos seguir e saber de todas as ofertas</div></td>
              </tr>
            </table>
        </div></td>
      </tr>

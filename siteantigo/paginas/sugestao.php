...
if(isset($_POST['enviar']) && $_POST['enviar'] == 'enviar'){
	 ...
	 $assunto =  "Sugestão de produtos para distribuição";
	...
	if(mail($email,$assunto,$mensagem,$headers)){
		...
		unset($nome, $email, $assunto, $mensagem);
		echo "Não foi possível enviar a sugestão!";
	}
}
?>
...
<?php include "busca.php"; ?>
	<div id="titulo_principal"><span class="titulo_principal"><?php echo convertem("Sugestão de Produto para Distribuição",1); ?></span></div>
...
<span class="texto_contato">Escreva aqui sua sugestão de produto</span>

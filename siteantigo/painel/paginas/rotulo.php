...
if(isset($_POST['gravar']) && $_POST['gravar'] == "Gravar"){
	...
	//PEGAR OS DADOS
	$dados = $_POST["dados"];
	$titulo =    	strip_tags(trim($dados['tbrotulo']['titulo']));
	...
	$id = $_GET['apagar'];
	$resultado = $conecta->selecionar("DELETE FROM tbrotulo WHERE id = $id");
	if($resultado == 1){
	...
	$id = $_GET['alterar'];
	$resultado = $conecta->selecionar("SELECT * FROM tbrotulo WHERE id = $id");
...
<div id="conteudodireita">
	...
	<form name="formcategoriaproduto" method="post" enctype="multipart/form-data" action="">
    	...
    	<fieldset>
        	<legend>Cadastro de Rótulo (Destaque) </legend>
            <label>
            <span class="titulo_form">Título:</span>
            <input class="input_painel" type="text" name="dados[tbrotulo][titulo]" value="<?php echo $titulo; ?>" />
            </label>
            <br/>
    ...
    <?php } else {?>
        ...
        <table cellpadding="0" cellspacing="3" width="100%">
            ...
            <tr>
                <td colspan="5" align="right"><span class="link_interno"><a href="home.php?pagina=rotulo&amp;vw=1&amp;tela=<?php echo $tela_id;?>" ><img src="../images/novo2.png" width="16" height="16" border="0" /> Inserir Rotulo (Destaque)</a></span></td>
            </tr>
            <tr>
            ...
            <tr bgcolor="<?php echo $cor;?>">
                ...
                <td class="dados_grid" align="center"><a href="home.php?pagina=rotulo&amp;vw=1&amp;tela=<?php echo $tela_id;?>&amp;alterar=<?php echo$rs['id']?>" ><img src="../images/editar.png" width="16" height="16" border="0" /></a></td>
                <td class="dados_grid" align="center"><a href="home.php?pagina=rotulo&amp;tela=<?php echo $tela_id;?>&amp;apagar=<?php echo$rs['id']?>" ><img src="../images/apagar.png" width="16" height="16" border="0" /></a></td>
            </tr>
            <?php } ?>
        </table>
        </div>

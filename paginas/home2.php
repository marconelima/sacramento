        ...
        <div class="container">
            ...
            <div class="row services" >
                <ul id="flexiselDemo2">
					...
					?>
                    <li class="col-sm-3" >
                        <article class="post-wrap" style="background: <?php echo $rs_configuracao['fundo_box_destaque']?> !important;  border: 1px solid <?php echo $rs_configuracao['fundo_box_destaque']?>;">
  ...
  right: 135; margin: 0;
    width: 100px;">
                            ...
                            <div class="post-footer text-center">
                                <a href="<?php echo $siteUrl?>produto/21/0/<?php echo $rs_destaque['id'];?>" class="btn btn-default add2cart" style="margin-bottom:2%;"><i class="fa fa-shopping-cart"></i> Adicionar Orçamento</a>
                            </div>
                        </article><!-- /.post-wrap -->
                    </li>
                    <?php } ?>
...
<section class="page-section" id="" style="padding-top:80px; background:<?php echo $rs_configuracao['fundo_container_produtosselecionados'];?>">
    <div class="container">
        ...
        <div class="row " >
            <div style="width:32%; float:left; margin-right:2%; min-height:600px; background: <?php echo $rs_configuracao['fundo_box_selecionados']?> !important;  border: 1px solid <?php echo $rs_configuracao['fundo_box_selecionados']?>;">
				...
				<div style="width:32%; float:left; margin-right:0%; min-height:600px; background: <?php echo $rs_configuracao['fundo_box_selecionados']?> !important;  border: 1px solid <?php echo $rs_configuracao['fundo_box_selecionados']?>;">
    ...
    <div class="container">
        ...
        <div class="row " >
            ...
            <ul id="flexiselDemo3">
                ...
                ?>
                <li class="col-sm-3" style="background: <?php echo $rs_configuracao['fundo_box_premium']?> !important;  border: 1px solid <?php echo $rs_configuracao['fundo_box_premium']?>;">
                    <article class="post-wrap">
                        <div class="post-media">
                            <div class="thumbnail do-hover">
    ...
    <div class="container">
        ...
        <div class="row " >
            <ul id="flexiselDemo4">
                ...
                ?>
                <li class="col-sm-3" style="background: <?php echo $rs_configuracao['fundo_box_kits']?> !important;  border: 1px solid <?php echo $rs_configuracao['fundo_box_kits']?>;">
                    <article class="post-wrap">
                        <div class="post-media">
                            <div class="thumbnail do-hover">
...
<?php if($rs_configuracao['container_foto'] > 0) { ?>
    ...
    <section id="content" class="gallery page-section">
        <div class="container">
            <div class="text-center" data-animation="fadeInUp" data-animation-delay="0">
                <h1 class="main-title">GALERIA DE FOTOS</h1>
            </div>
            <div class="row">


                <?php while($rs_fotos = mysqli_fetch_array($resultado_fotos)) { ?>
                <div class="col-sm-4 grid_4 panties gallery_iten">
                        <div class="box">
...
<?php if($rs_configuracao['container_produtosultimos'] > 0) { ?>
    <section class="page-section" id="" style="margin-top:80px;">
        <div class="container">
            <div class="text-center" data-animation="fadeInUp" data-animation-delay="0">
                <h1 class="main-title">ÚLTIMOS PRODUTOS CADASTRADOS</h1>
            </div>
            <div class="row " >
                <ul id="flexiselDemo5">
                    ...
                    ?>
                    <li class="col-sm-3" style="background: <?php echo $rs_configuracao['fundo_box_ultimos']?> !important;  border: 1px solid <?php echo $rs_configuracao['fundo_box_ultimos']?>;">
                        <article class="post-wrap">
                            <div class="post-media">
                                <div class="thumbnail do-hover">
                                    <img class="img-responsive" src="<?php echo $siteUrl."source/Produtos/".$rs_ultimos['foto'];?>" alt=""/>
    ...
    width: 100px;">
                                    ...
                                    <div class="caption">
                                        <div class="caption-wrapper div-table" style="height: 100% !important;">
                                            <div class="caption-inner div-cell">
                                                <p class="caption-buttons">
                                                    <a href="<?php echo $siteUrl?>produto/21/0/<?php echo $rs_ultimos['id'];?>" class="btn caption-zoom theone"><i class="fa fa-link"></i></a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="post-header text-center">
                                <div class="shop-category"><a href="<?php echo $siteUrl?>catalogo/21/0/0/0/0/0/0/0/<?php echo $rs_ultimos['marca_id']?>"><?php echo $rs_ultimos['marca'];?></a></div>
                                <h2 class="post-title"><a href="<?php echo $siteUrl?>produto/21/0/<?php echo $rs_ultimos['id'];?>"><?php echo $rs_ultimos['nome']." . ".$rs_ultimos['modelo'];?></a></h2>
                                <?php if($promocional == 1 && $rs_premium['preco_promocional'] > 0){ ?>
                                    <h3 class="post-title" style="text-decoration: line-through; color:#FF0000; font-size:16px !important; font-weight:normal;"><strong><?php echo "de R$ ".number_format($rs_ultimos['preco'],2,",",".");?></strong></h3>
                                    <h2 class="post-title"><strong><?php echo "por R$ ".number_format($rs_ultimos['preco_promocional'],2,",",".");?></strong></h2>
                                <?php } else { ?>
                                    <h2 class="post-title"><strong><?php echo ($rs_ultimos['preco'] > 0 ? "R$ ".number_format($rs_ultimos['preco'],2,",",".") : "PREÇO SOB-CONSULTA");?></strong></h2>
                                <?php } ?>

                            </div>
                            <div class="post-footer text-center">
                                <a href="<?php echo $siteUrl?>produto/21/0/<?php echo $rs_ultimos['id'];?>" class="btn btn-default add2cart"><i class="fa fa-shopping-cart"></i> Adicionar Orçamento</a>
                            </div>
                        </article><!-- /.post-wrap -->
                    </li>
                    <?php } ?>
...
<section class="page-section" id="" style="margin-top:80px;">
    <div class="container">
        <div class="text-center" data-animation="fadeInUp" data-animation-delay="0">
            <h1 class="main-title">NOSSOS PARCEIROS</h1>
        </div>
        <div class="row " >
            <ul id="manufacturers2">
                <?php while($rs_parceiro2 = mysqli_fetch_array($resultado_parceiro2)) {?>
                <li><a href="<?php echo $siteUrl?>catalogo/21/0/0/0/0/0/0/0/<?php echo $rs_parceiro2['id']?>"><img src="imagens/<?php echo $rs_parceiro2['arquivo'];?>" title="<?php echo $rs_parceiro2['titulo'];?>" alt="<?php echo $rs_parceiro2['titulo'];?>" /></a></li>
                <?php } ?>
            </ul>
        </div>
    </div>
...
<section class="page-section" id="" style="margin-top:80px;">
    <div class="container">
        <div class="row " >
            ...
            <div class="banner_rodape"><a href="<?php echo $rs_banner_rodape['link'];?>" target="_blank"><img style="height:160px; width:100% !important;" class="rsImg" src="<?php echo $rs_banner_rodape['arquivo']?>" alt="" border="0" /></a></div>
            <?php } ?>
        </div>
    </div>
</section>

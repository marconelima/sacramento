    ...
    <div class="container">
        <div class="row">
            <nav id="categories_list">
                <ul>
                    <a href="<?php echo $siteUrl2?>fotos/10"><li id="all" class="category_iten <?php if($categ == '' || empty($categ)) { echo "categories_ativo"; }?>">todos</li></a>
                    <?php while($rs_categoria = mysqli_fetch_array($resultado_categoria)){ ?>
                    <a href="<?php echo $siteUrl2?>fotos/10/0/0/<?php echo $rs_categoria['id'];?>"><li id="bra" class="category_iten <?php if($categ == $rs_categoria['id']) { echo "categories_ativo"; }?>"><?php echo convertem($rs_categoria['titulo'],1);?></li></a>
                    <?php } ?>
                </ul>
            </nav>
